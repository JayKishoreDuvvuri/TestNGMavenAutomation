...
public class WebTest {
	...
	public void signInTest() {
	   ...
	   @Parameters({"existingUserEmail", "existingUserPassword", "FullName"})
	   @Test(priority=2)
	public void logInTest(String existingUserEmail, String existingUserPassword, String FullName) {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("login"))).click();
	...
	@Parameters({ "existingUserEmail", "existingUserPassword" })
	@Test(priority = 3)
	public void checkoutTest(String existingUserEmail, String existingUserPassword) {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("login"))).click();
		driver.findElement(By.id("email")).sendKeys(existingUserEmail);
		driver.findElement(By.id("passwd")).sendKeys(existingUserPassword);
		driver.findElement(By.id("SubmitLogin")).click();
        ...
        // Problem with Element is not visible or it is Hidden so use below 'OR' Solutions
		//                                OR
		// WebElement elem = driver.findElement(By.xpath("//button[@name='Submit']"));
		...
		//                                  OR	
		//WebElment element = driver.findElement(By.xpath("//span[contains(text(),'Add to cart')]"))
